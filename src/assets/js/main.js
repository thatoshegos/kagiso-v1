...
$(document).ready(function () {
    ...
    $('.accordion-style2 .collapse').on('show.bs.collapse', function () {
        var id = $(this).attr('id');
        $('a[href="#' + id + '"]').closest('.panel-heading').addClass('active-accordion');
        $('a[href="#' + id + '"] .panel-title').find('div').addClass('faq-minus').removeClass('faq-plus');
    });

    $('.accordion-style2 .collapse').on('hide.bs.collapse', function () {
        var id = $(this).attr('id');
        $('a[href="#' + id + '"]').closest('.panel-heading').removeClass('active-accordion');
        $('a[href="#' + id + '"] .panel-title').find('div').removeClass('faq-minus').addClass('faq-plus');
    });
...
$(".slider-arrow-down").click(function() {
    $('html,body').animate({
        scrollTop: $(".unconventional-thinking").offset().top},
        'slow');
});